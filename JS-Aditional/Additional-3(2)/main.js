...
userBox.style.cssText = 'display: flex; justify-content:center; align-items: center; flex-wrap: wrap; column-gap: 10px'
let userBlock = document.getElementsByClassName('user-block')
for (const userBlockElement of userBlock) {
    userBlockElement.style.cssText = 'width: 45%; border: 3px solid green; padding: 15px; margin-top: 10px; text-align: center'
}
